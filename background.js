  ...
  try {
    ...
    if (message.action === "sendLinks" && sender.tab) {
      ...
      try {
        ...
        const responseData = {
          main_url: {
            score_fiable_global: data.score_fiable || 0.36883333292915867,
            score_faux_global: data.score_faux || 0.63116666666666667,
            scores_paragraphes: data.scores_paragraphes || []
          }
        };
